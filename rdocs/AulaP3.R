...
p_load(dglm,car,gamlss,GLMsData)
...
source("rdocs/envel_norm_dglm.R") # Avalia o ajuste do submodelo da media
source("rdocs/envel_norm_dglm_disp.R") # Avalia o ajuste do submodelo da precisao

#Graficos de diagnostico
source("rdocs/diag_norm_dglm.R")  # Diagnostico do ajuste do submodelo da media
source("rdocs/diag_norm_dglm_disp.R")  # Diagnostico do ajuste do submodelo da precisao/dispersao
...
summary(fitG1)
fit.model <- fitG1
source("rdocs/envel_gama_lig_id.R") 
...
summary(fitG2)
fit.model <- fitG2
source("rdocs/envel_gama_dglm_lig_id.R") 
source("rdocs/envel_gama_dglm_disp_lig_id.R")
source("rdocs/diag_gama_dglm.R")
